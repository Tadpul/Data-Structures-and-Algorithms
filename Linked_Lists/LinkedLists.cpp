...
bool LinkedList::setNode(int index, int val)
{
	if (index >= 0 && index < numOfNodes)
	{
...
bool LinkedList::insertNode(int index, int val)
{
...
void LinkedList::reverseBetween(int index1, int index2)
{
